...
{   
    ...
    /* Select prescalar value */
    PLIB_TMR_PrescaleSelect(TMR_ID_6, TMR_PRESCALE_VALUE_1);
    /* Enable 32 bit mode */
    PLIB_TMR_Mode32BitEnable(TMR_ID_6);
    /* Clear counter */
    PLIB_TMR_Counter32BitClear(TMR_ID_6);
    /*Set period */ 
    PLIB_TMR_Period32BitSet(TMR_ID_6, 0UL);
    ...
    /* Setup Interrupt */   
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_T6, INT_PRIORITY_LEVEL4);
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_T6, INT_SUBPRIORITY_LEVEL1);          
}
...
void DRV_TMR1_CounterValueSet(uint32_t value)
{
    ...
    PLIB_TMR_Counter32BitSet(TMR_ID_6, value);
}

uint32_t DRV_TMR1_CounterValueGet(void)
{
    /* Get 32-bit counter value*/
    return PLIB_TMR_Counter32BitGet(TMR_ID_6);
}
...
{
    /* Set 32-bit counter value*/
    PLIB_TMR_Period32BitSet(TMR_ID_6, value);
}

uint32_t DRV_TMR1_PeriodValueGet(void)
{
    /* Get 32-bit counter value*/
    return PLIB_TMR_Period32BitGet(TMR_ID_6);
}
...
)
{
    ...
    if (success)
    {
        PLIB_INT_SourceDisable(INT_ID_0, INT_SOURCE_TIMER_6);
        PLIB_TMR_Stop(TMR_ID_6);
        PLIB_TMR_Period32BitSet(TMR_ID_6, divider - 1);
