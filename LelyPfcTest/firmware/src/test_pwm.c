...
static void test_pwm_setCurrentLimit(){
    ...
    PLIB_MCPWM_ChannelCurrentLimitSetup(MCPWM_ID_0, PWM_ChanBoost1, MCPWM_CURRENTLIMIT_SOURCE_IS_COMPARATOR1, MCPWM_CURRENTLIMIT_INPUT_POLARITY_ACTIVE_HIGH, MCPWM_CURRENTLIMIT_OVERRIDE_PWMxH_0, MCPWM_CURRENTLIMIT_OVERRIDE_PWMxL_0, MCPWM_STANDARD_CURRENT_LIMIT_MODE_ENABLE);
    PLIB_MCPWM_ChannelCurrentLimitSetup(MCPWM_ID_0, PWM_ChanBoost2, MCPWM_CURRENTLIMIT_SOURCE_IS_COMPARATOR1, MCPWM_CURRENTLIMIT_INPUT_POLARITY_ACTIVE_HIGH, MCPWM_CURRENTLIMIT_OVERRIDE_PWMxH_0, MCPWM_CURRENTLIMIT_OVERRIDE_PWMxL_0, MCPWM_STANDARD_CURRENT_LIMIT_MODE_ENABLE);
    PLIB_MCPWM_ChannelCurrentLimitSetup(MCPWM_ID_0, PWM_ChanBoost3, MCPWM_CURRENTLIMIT_SOURCE_IS_COMPARATOR1, MCPWM_CURRENTLIMIT_INPUT_POLARITY_ACTIVE_HIGH, MCPWM_CURRENTLIMIT_OVERRIDE_PWMxH_0, MCPWM_CURRENTLIMIT_OVERRIDE_PWMxL_0, MCPWM_STANDARD_CURRENT_LIMIT_MODE_ENABLE);
    PLIB_MCPWM_ChannelCurrentLimitSetup(MCPWM_ID_0, PWM_ChanBoost4, MCPWM_CURRENTLIMIT_SOURCE_IS_COMPARATOR1, MCPWM_CURRENTLIMIT_INPUT_POLARITY_ACTIVE_HIGH, MCPWM_CURRENTLIMIT_OVERRIDE_PWMxH_0, MCPWM_CURRENTLIMIT_OVERRIDE_PWMxL_0, MCPWM_STANDARD_CURRENT_LIMIT_MODE_ENABLE);
    PLIB_MCPWM_ChannelCurrentLimitSetup(MCPWM_ID_0, PWM_ChanBuck1, MCPWM_CURRENTLIMIT_SOURCE_IS_COMPARATOR1, MCPWM_CURRENTLIMIT_INPUT_POLARITY_ACTIVE_HIGH, MCPWM_CURRENTLIMIT_OVERRIDE_PWMxH_0, MCPWM_CURRENTLIMIT_OVERRIDE_PWMxL_0, MCPWM_STANDARD_CURRENT_LIMIT_MODE_ENABLE);
    PLIB_MCPWM_ChannelCurrentLimitSetup(MCPWM_ID_0, PWM_ChanBuck2, MCPWM_CURRENTLIMIT_SOURCE_IS_COMPARATOR1, MCPWM_CURRENTLIMIT_INPUT_POLARITY_ACTIVE_HIGH, MCPWM_CURRENTLIMIT_OVERRIDE_PWMxH_0, MCPWM_CURRENTLIMIT_OVERRIDE_PWMxL_0, MCPWM_STANDARD_CURRENT_LIMIT_MODE_ENABLE);
    PLIB_MCPWM_ChannelCurrentLimitSetup(MCPWM_ID_0, PWM_ChanBuck3, MCPWM_CURRENTLIMIT_SOURCE_IS_COMPARATOR1, MCPWM_CURRENTLIMIT_INPUT_POLARITY_ACTIVE_HIGH, MCPWM_CURRENTLIMIT_OVERRIDE_PWMxH_0, MCPWM_CURRENTLIMIT_OVERRIDE_PWMxL_0, MCPWM_STANDARD_CURRENT_LIMIT_MODE_ENABLE);
    PLIB_MCPWM_ChannelCurrentLimitSetup(MCPWM_ID_0, PWM_ChanBuck4, MCPWM_CURRENTLIMIT_SOURCE_IS_COMPARATOR1, MCPWM_CURRENTLIMIT_INPUT_POLARITY_ACTIVE_HIGH, MCPWM_CURRENTLIMIT_OVERRIDE_PWMxH_0, MCPWM_CURRENTLIMIT_OVERRIDE_PWMxL_0, MCPWM_STANDARD_CURRENT_LIMIT_MODE_ENABLE);
